...
public class DanseMarionnette : MonoBehaviour {
   ...
   // public GameObject m_imageTarget ;
    ...
    private Vector3 _m_FirstPOsition;
    GameObject _m_Index;
	...
	void Awake () {
        ...
        _m_FirstPOsition = transform.localPosition;
    ...
    void Update()
    {
        ...
        {   
            ...
            transform.localPosition = _m_FirstPOsition;
        }
        else
        {
